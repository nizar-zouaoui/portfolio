...
const getSizeClass = (size: IconProps["size"] = "md") => sizeClasses[size];
...
export const UsersIcon: React.FC<IconProps> = ({ className = "", size }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-7.5a3 3 0 11-6 0 3 3 0 016 0z"
    />
  </svg>
);
...
export const EditIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const DeleteIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const SaveIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const XCircleIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="currentColor"
    viewBox="0 0 20 20"
...
// Form Icons
export const EyeIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const EyeSlashIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const LoadingSpinner: React.FC<IconProps> = ({
  ...
  <svg
    className={`${getSizeClass(size)} ${className} animate-spin`}
    fill="none"
    viewBox="0 0 24 24"
  >
    <circle
...
// Table & List Icons
export const SortIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const FilterIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
export const CogIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
// Document Icons
export const DocumentIcon: React.FC<IconProps> = ({ className = "", size }) => (
  <svg
    className={`${getSizeClass(size)} ${className}`}
    fill="none"
    stroke="currentColor"
...
// Theme Icons (for dark mode toggle)
...
// Export all icons as default collection
export const Icons = {
  // User & Account
  User: UserIcon,
  Users: UsersIcon,
